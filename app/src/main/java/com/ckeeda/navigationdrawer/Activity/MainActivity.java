...
import com.ckeeda.navigationdrawer.MainActivityView;
...
public class MainActivity extends AppCompatActivity
    ...
    public void navigatetoList() {
        Intent FlowerListActivity = new Intent(this,FlowerListActivity.class);
        FlowerListActivity.putExtra("Title","Retrofit");
        startActivity(FlowerListActivity);

    }

    public void navigatetoPracticeActivity() {
